...
const TasksScreen = (props) => {
  ...
  const tasks = [...daily, ...special, ...weekly];
  const claim = (task) => {
    var _a, _b;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full overflow-y-auto bg-[#05060b] px-4 pb-28 pt-5 text-zinc-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-3xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-[0.18em] text-cyan-200/70", children: "成长目标" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-1 text-2xl font-black", children: "任务" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-4 text-sm leading-6 text-zinc-400", children: "完成钓鱼、收集和成长目标，达到条件后直接领取游戏内奖励。" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", children: tasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-cyan-300/15 bg-black/65 p-5 text-center text-zinc-300", children: "当前没有可显示的任务，先去钓几条鱼吧。" }) : tasks.map((task, index) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-cyan-300/15 bg-black/65 p-4 text-zinc-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-xs text-zinc-500", children: ["状态：",completed ? "已完成" : claimable ? "可领取" : "进行中"] })
        ] }),
