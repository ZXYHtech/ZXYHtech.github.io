import { aS as getAugmentedNamespace, bK as commonjsGlobal, cn as tslib_es6, a4 as getDefaultExportFromCjs } from "./index-tWfloERs.js";
import { p as preact_module, a as hooks_module } from "./hooks.module-DeCOxI3p.js";
import { e as eventsExports } from "./events-DQlC5oWO.js";
...
(function(exports) {
  ...
  function getMessageFromCode(code2, fallbackMessage = FALLBACK_MESSAGE) {
    if (code2 && Number.isInteger(code2)) {
...
errors$1.standardErrors = {
  ...
  provider: {
    ...
    custom: (opts) => {
      ...
      return new EthereumProviderError$1(code2, message, data);
    }
  }
};
function getEthJsonRpcError$1(code2, arg) {
  const [message, data] = parseOpts$1(arg);
  return new EthereumRpcError$1(code2, message || (0, utils_1$2.getMessageFromCode)(code2), data);
}
function getEthProviderError$1(code2, arg) {
  const [message, data] = parseOpts$1(arg);
  return new EthereumProviderError$1(code2, message || (0, utils_1$2.getMessageFromCode)(code2), data);
}
...
(function(module, exports) {
  ...
  SafeBuffer.allocUnsafeSlow = function(size2) {
    ...
    return buffer$1.SlowBuffer(size2);
  };
...
var useFromArrayBuffer = useArrayBuffer && (Buffer$8.prototype instanceof Uint8Array || Buffer$8.TYPED_ARRAY_SUPPORT);
var toBuffer$2 = function toBuffer(data, encoding) {
  if (Buffer$8.isBuffer(data)) {
    if (data.constructor && !("isBuffer" in data)) {
      return Buffer$8.from(data);
    }
    return data;
  }
  if (typeof data === "string") {
    return Buffer$8.from(data, encoding);
  }
  if (useArrayBuffer && isView(data)) {
    ...
    if (useFromArrayBuffer) {
      var res = Buffer$8.from(data.buffer, data.byteOffset, data.byteLength);
      if (res.byteLength === data.byteLength) {
        return res;
      }
    }
    var uint8 = data instanceof Uint8Array ? data : new Uint8Array(data.buffer, data.byteOffset, data.byteLength);
    var result = Buffer$8.from(uint8);
  ...
  if (isArr || Buffer$8.isBuffer(data) && data.constructor && typeof data.constructor.isBuffer === "function" && data.constructor.isBuffer(data)) {
    return Buffer$8.from(data);
  }
...
Sha.prototype._update = function(M) {
  ...
  for (var j = 0; j < 80; ++j) {
    var s = ~~(j / 20);
    var t2 = rotl5$1(a) + ft$1(s, b, c, d) + e + w[j] + K$3[s] | 0;
    e = d;
    d = c;
    c = rotl30$1(b);
    b = a;
...
Sha1.prototype._update = function(M) {
  ...
  for (var j = 0; j < 80; ++j) {
    var s = ~~(j / 20);
    var t2 = rotl5(a) + ft(s, b, c, d) + e + w[j] + K$2[s] | 0;
    e = d;
    d = c;
    c = rotl30(b);
    b = a;
...
function r(e) {
  ...
  else if ("object" == typeof e) if (Array.isArray(e)) for (t2 = 0; t2 < e.length; t2++) e[t2] && (f = r(e[t2])) && (n && (n += " "), n += f);
  else for (t2 in e) e[t2] && (n && (n += " "), n += t2);
  return n;
}
function clsx() {
  for (var e, t2, f = 0, n = ""; f < arguments.length; ) (e = arguments[f++]) && (t2 = r(e)) && (n && (n += " "), n += t2);
  return n;
}
...
const debug_1 = __importDefault$4(browserExports);
