import { d as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, S as Sparkles, C as Card } from "./index-BS_fjQJr.js";
/**
...
const WheelScreen = ({ coins = 0, availableRolls = 0, onRequestRoll, onResolveReward, onOpenTasks, onSpinStartSound, onRevealSound, onRewardSound }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div",{className:"h-full overflow-y-auto bg-[#05060b] px-4 pb-28 pt-6 text-zinc-100",children:/* @__PURE__ */jsxRuntimeExports.jsxs("div",{className:"mx-auto flex min-h-[75vh] w-full max-w-2xl flex-col items-center justify-center",children:[
    ...
    /* @__PURE__ */jsxRuntimeExports.jsx("p",{className:"mt-2 max-w-md text-center text-sm leading-6 text-zinc-400",children:"使用游戏内获得的次数抽取奖励，完成任务还能继续获得次数。"}),
    ...
    /* @__PURE__ */jsxRuntimeExports.jsxs("div",{className:"mt-6 flex gap-2 text-xs font-bold",children:[/* @__PURE__ */jsxRuntimeExports.jsxs("span",{className:"rounded-full border border-cyan-300/20 bg-black/70 px-3 py-1.5",children:["可用次数：",localRolls]}),/* @__PURE__ */jsxRuntimeExports.jsxs("span",{className:"rounded-full border border-amber-300/20 bg-black/70 px-3 py-1.5",children:["金币：",coins]})]}),
    /* @__PURE__ */jsxRuntimeExports.jsxs(Button,{onClick:spin,disabled:busy||localRolls<=0,className:"mt-5 min-h-12 min-w-44 rounded-2xl bg-violet-300 px-7 text-base font-black text-black hover:bg-violet-200",children:[/* @__PURE__ */jsxRuntimeExports.jsx(Sparkles,{className:"mr-2 h-5 w-5"}),busy?"魔方转动中…":localRolls>0?"转动魔方":"暂无可用次数"]}),
    lastPrize&&/* @__PURE__ */jsxRuntimeExports.jsxs(Card,{className:"mt-5 w-full max-w-sm border-cyan-300/20 bg-black/75 p-5 text-center text-zinc-100",children:[/* @__PURE__ */jsxRuntimeExports.jsx("p",{className:"text-xs font-black uppercase tracking-[0.16em] text-cyan-200/70",children:"本次奖励"}),/* @__PURE__ */jsxRuntimeExports.jsx("p",{className:"mt-2 text-xl font-black text-cyan-100",children:prizeLabel(lastPrize)})]}),
    localRolls<=0&&/* @__PURE__ */jsxRuntimeExports.jsx(Button,{onClick:onOpenTasks,variant:"outline",className:"mt-4 rounded-xl border-cyan-300/20 bg-black text-cyan-100 hover:bg-zinc-950",children:"去任务页获取更多次数"}),
    /* @__PURE__ */jsxRuntimeExports.jsx("p",{className:"mt-5 text-center text-xs text-zinc-600",children:"完成任务可获得更多抽取次数。"})
  ]})});
};
export { WheelScreen as default };