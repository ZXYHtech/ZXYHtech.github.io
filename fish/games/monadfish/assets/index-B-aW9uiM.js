...
import { c as createStore, p as persist, a as createJSONStorage, b as createPublicClient, d as createBundlerClient, e as p256, w as waitForCallsStatus, t as toSmartAccount, g as getUserOperationHash, f as parseSignature, h as encodePacked, i as entryPoint06Abi, j as entryPoint06Address } from "./createBundlerClient-CjujXfJl.js";
import { l, B, _, h, y, T } from "./hooks.module-DeCOxI3p.js";
import { aX as isAddress, aY as InvalidAddressError, bM as InvalidChainIdError, bN as EmptyBlobError, bu as size$2, b8 as hexToNumber, bO as slice$2, bP as InvalidVersionedHashSizeError, bQ as versionedHashVersionKzg, bR as InvalidVersionedHashVersionError, bS as maxUint256$1, bT as FeeCapTooHighError, bU as TipAboveFeeCapError, a5 as BaseError$1, bV as InvalidStorageKeySizeError, bW as getTransactionType, aW as concatHex, bX as toRlp, b1 as numberToHex, bY as bytesToHex, bZ as blobsToCommitments, b_ as commitmentsToVersionedHashes, b$ as blobsToProofs, c0 as toBlobSidecars, c1 as InvalidLegacyVError, bb as trim, c2 as toHex$2, c3 as defineBlock, c4 as formatTransaction, b9 as hexToBigInt, c5 as defineTransaction, c6 as defineTransactionReceipt, c7 as defineChain, a4 as getDefaultExportFromCjs, c8 as mainnet, c9 as http, ag as isHex, bL as hashMessage, bv as hashTypedData, bw as keccak256, ca as stringToBytes, b7 as hexToBytes, cb as decodeFunctionData, bF as encodeFunctionData, ae as encodeAbiParameters, a_ as stringToHex, cc as hexToString, bz as getCode, bx as readContract, aZ as pad$1, cd as decodeAbiParameters, a9 as isAddressEqual } from "./index-tWfloERs.js";
import { c as createStore$1, g as get$1, d as del, s as set } from "./index-C8FGXYRu.js";
...
function assertTransactionEIP4844(transaction) {
  ...
  if (blobVersionedHashes) {
    ...
    for (const hash of blobVersionedHashes) {
      ...
      const version2 = hexToNumber(slice$2(hash, 0, 1));
      if (size_ !== 32)
...
function serializeAuthorizationList(authorizationList) {
  ...
  for (const authorization of authorizationList) {
    ...
    serializedAuthorizationList.push([
      chainId ? toHex$2(chainId) : "0x",
      contractAddress,
      nonce ? toHex$2(nonce) : "0x",
...
function serializeTransactionDeposit(transaction) {
  ...
  const serializedTransaction = [
    ...
    from2,
    to ?? "0x",
    mint ? toHex$2(mint) : "0x",
    value ? toHex$2(value) : "0x",
    gas ? toHex$2(gas) : "0x",
    isSystemTx ? "0x1" : "0x",
    data ?? "0x"
  ];
...
function assertTransactionDeposit(transaction) {
  ...
  if (from2 && !isAddress(from2))
    throw new InvalidAddressError({ address: from2 });
  if (to && !isAddress(to))
    throw new InvalidAddressError({ address: to });
}
const chainConfig = {
...
const description = "Base Account SDK";
const keywords = [
  "base",
  "account",
  "sdk",
...
const browser = "dist/base-account.min.js";
const exports = {
  ".": {
...
const repository = "https://github.com/base/account-sdk.git";
const author = "Base";
...
function logEvent(name2, event, importance) {
  ...
  if (typeof window !== "undefined" && window.ClientAnalytics) {
    (_b = window.ClientAnalytics) == null ? void 0 : _b.logEvent(name2, {
      ...event,
...
function defineChainConfig(chainId, rpcUrl, options) {
  ...
  const name2 = (nativeCurrency == null ? void 0 : nativeCurrency.name) ?? (viemChain == null ? void 0 : viemChain.name) ?? "";
...
function toWebAuthnSignature({ webauthn, signature }) {
  const { r: r2, s } = fromHex$1(signature);
