  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full overflow-y-auto bg-[#05060b] px-4 pb-28 pt-5 text-zinc-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto w-full max-w-3xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-end justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-[0.18em] text-cyan-200/70", children: "补给与装备" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 text-xs font-bold", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full border border-amber-300/20 bg-black/70 px-3 py-1.5", children: [/* @__PURE__ */ jsxRuntimeExports.jsx(CoinIcon, { size: "sm" })," ",coins," 金币"] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full border border-cyan-300/20 bg-black/70 px-3 py-1.5", children: [/* @__PURE__ */ jsxRuntimeExports.jsx(Worm, { className: "h-4 w-4" })," ",totalBait," 鱼饵"] })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-cyan-300/15 bg-black/65 p-4 text-zinc-100", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-2", children: rods.map((rod) => {
        const cost = Number(rod.coinCost || 0); const owned = rod.level <= rodLevel;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 rounded-xl border border-zinc-800 bg-zinc-950/80 p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [/* @__PURE__ */ jsxRuntimeExports.jsx("b", { className: "block", children: rod.name || `鱼竿 Lv.${rod.level}` }),/* @__PURE__ */ jsxRuntimeExports.jsxs("small", { className: "text-zinc-400", children: ["等级 ",rod.level] })] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-center text-xs text-zinc-500", children: "优先补充鱼饵，再按常用玩法逐步升级鱼竿。" })
  ] }) });
};
export { ShopScreen as default };
