const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/secp256k1-o9DJiQTV.js","assets/index-tWfloERs.js","assets/index-9VQBiT8i.css","assets/events-DQlC5oWO.js","assets/index.es-CnRF0ZqS.js","assets/index-C8FGXYRu.js","assets/basic-Blra7_TT.js","assets/index-QYuLooBx.js","assets/w3m-modal-CWrqe4Nl.js"])))=>i.map(i=>d[i]);
var _b;
import { cg as createTransport, ch as TransactionRejectedRpcError, ci as UserRejectedRequestError, cj as WalletConnectSessionSettlementError, ck as ExecutionRevertedError, cl as wait, cm as formatUnits, aU as __vitePreload, c9 as http, c2 as toHex$1 } from "./index-tWfloERs.js";
import { e as eventsExports, N as Nt$2 } from "./events-DQlC5oWO.js";
import { h as destr, s as safeJsonStringify, i as safeJsonParse, I as IEvents, j as getWindowMetadata_1, k as cjs, l as fromString, m as toString, n as getDocument_1, o as getNavigator_1, C as C$3, p as detect, q as getLocation_1, u as concat, v as sn$2, E as E$5, y as y$7, x as k$5, A as A$3, z as i$5, O as Ot$2, B as o$4, D as f$4, F as isJsonRpcRequest, G as isJsonRpcResponse, J as formatJsonRpcResult, K as r$3, L as formatJsonRpcRequest, P as Po$1, Q as Qe$3, M as Qo, N as getBigIntRpcId, R as formatJsonRpcError, S as isJsonRpcResult, T as isJsonRpcError, U as payloadId, V as f$5 } from "./index.es-CnRF0ZqS.js";
import { c as createStore, g as get, s as set, d as del, k as keys, a as clear } from "./index-C8FGXYRu.js";
...
const ConstantsUtil$3 = {
  ...
  SECURE_SITE_SDK_ORIGIN: (typeof process !== "undefined" && typeof define_process_env_default$4 !== "undefined" ? define_process_env_default$4["NEXT_PUBLIC_SECURE_SITE_ORIGIN"] : void 0) || "https://secure.walletconnect.org"
};
const NetworkUtil$1 = {
...
const __vite_import_meta_env__ = { "BASE_URL": "/fish/games/monadfish/", "DEV": false, "MODE": "production", "PROD": true, "SSR": false, "VITE_BASE_PATH": "/fish/games/monadfish/" };
...
const SECURE_SITE = (
  ...
  (typeof process !== "undefined" && typeof define_process_env_default$3 !== "undefined" ? define_process_env_default$3["NEXT_PUBLIC_SECURE_SITE_ORIGIN"] : void 0) || "https://secure.walletconnect.org"
);
...
function createStorage(options = {}) {
  ...
  const storage = {
    ...
    async clear(base2, opts = {}) {
      base2 = normalizeBaseKey(base2);
      await Promise.all(
        getMounts(base2, false).map(async (m3) => {
          if (m3.driver.clear) {
    ...
    async unmount(base2, _dispose = true) {
      ...
      if (context.watching && base2 in context.unwatch) {
        (_b2 = (_a = context.unwatch)[base2]) == null ? void 0 : _b2.call(_a);
...
var T = Object.defineProperty, k$3 = (e2, s2, r2) => s2 in e2 ? T(e2, s2, { enumerable: true, configurable: true, writable: true, value: r2 }) : e2[s2] = r2, i$4 = (e2, s2, r2) => k$3(e2, typeof s2 != "symbol" ? s2 + "" : s2, r2);
let J$1 = class J {
  constructor(s2) {
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1 } = await __vitePreload(async () => {
    const { secp256k1: secp256k12 } = await import("./secp256k1-o9DJiQTV.js");
...
function base(ALPHABET2) {
  ...
  function encode(source) {
    ...
    while (pbegin !== pend) {
      ...
      let i2 = 0;
      for (let it1 = size2 - 1; (carry !== 0 || i2 < length) && it1 !== -1; it1--, i2++) {
        carry += 256 * b58[it1] >>> 0;
  ...
  function decodeUnsafe(source) {
    ...
    while (psz < source.length) {
      ...
      let i2 = 0;
      for (let it3 = size2 - 1; (carry !== 0 || i2 < length) && it3 !== -1; it3--, i2++) {
...
function si$1({ protocol: t2, version: e2, relayUrl: n3, sdkVersion: r2, auth: o2, projectId: i2, useOnCloseEvent: s2, bundleId: c2, packageName: a2 }) {
  const u2 = n3.split("?"), l2 = Mn$1(t2, e2, r2), f3 = { auth: o2, ua: l2, projectId: i2, useOnCloseEvent: s2 || void 0, packageName: a2 || void 0, bundleId: c2 || void 0 }, h4 = Cn$1(u2[1] || "", f3);
  return u2[0] + "?" + h4;
}
function gt$2(t2, e2) {
...
function Zi(t2, e2 = 24) {
  ...
  for (let r2 = 24 - e2; r2 < 24; r2++) {
    ...
    for (let s2 = 0; s2 < 10; s2 += 2) {
      const c2 = (s2 + 8) % 10, a2 = (s2 + 2) % 10, u2 = n3[a2], l2 = n3[a2 + 1], f3 = rr$1(u2, l2, 1) ^ n3[c2], h4 = or$1(u2, l2, 1) ^ n3[c2 + 1];
...
const hr$1 = (t2, e2) => {
  ...
  const i2 = `URI: ${t2.aud || t2.uri}`, s2 = `Version: ${t2.version}`, c2 = `Chain ID: ${lr$1(e2)}`, a2 = `Nonce: ${t2.nonce}`, u2 = `Issued At: ${t2.iat}`, l2 = t2.exp ? `Expiration Time: ${t2.exp}` : void 0, f3 = t2.nbf ? `Not Before: ${t2.nbf}` : void 0, h4 = t2.requestId ? `Request ID: ${t2.requestId}` : void 0, y4 = t2.resources ? `Resources:${t2.resources.map((p2) => `
...
function Is$1(t2, e2, n3, r2, o2, i2, s2, c2) {
  const a2 = o2.length, u2 = new Uint8Array(ge$2), l2 = mt$2(u2), f3 = Ye$2(o2) && Ye$2(i2), h4 = f3 ? mt$2(o2) : Tr$1, y4 = f3 ? mt$2(i2) : Tr$1;
...
function Ns$1(t2, e2) {
  ...
  return Fe$2(o2), Fe$2(s2), Ar$1(i2), Ar$1(n3), (c2, a2, u2, l2, f3 = 0) => {
    tt(c2), tt(a2), tt(u2);
    const h4 = u2.length;
    if (l2 === void 0 && (l2 = new Uint8Array(h4)), tt(l2), Fe$2(f3), f3 < 0 || f3 >= Ur$1) throw new Error("arx: counter overflow");
...
class Us {
  ...
  process(e2, n3, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: i2, r: s2 } = this, c2 = s2[0], a2 = s2[1], u2 = s2[2], l2 = s2[3], f3 = s2[4], h4 = s2[5], y4 = s2[6], E2 = s2[7], p2 = s2[8], d3 = s2[9], v2 = F$2(e2, n3 + 0), m3 = F$2(e2, n3 + 2), O3 = F$2(e2, n3 + 4), N2 = F$2(e2, n3 + 6), $2 = F$2(e2, n3 + 8), B3 = F$2(e2, n3 + 10), A2 = F$2(e2, n3 + 12), T2 = F$2(e2, n3 + 14);
...
function _s(t2, e2, n3, r2, o2, i2 = 20) {
  ...
  for (let M3 = 0; M3 < i2; M3 += 2) B3 = B3 + L2 | 0, R3 = V$3(R3 ^ B3, 16), g2 = g2 + R3 | 0, L2 = V$3(L2 ^ g2, 12), B3 = B3 + L2 | 0, R3 = V$3(R3 ^ B3, 8), g2 = g2 + R3 | 0, L2 = V$3(L2 ^ g2, 7), A2 = A2 + U2 | 0, x2 = V$3(x2 ^ A2, 16), w2 = w2 + x2 | 0, U2 = V$3(U2 ^ w2, 12), A2 = A2 + U2 | 0, x2 = V$3(x2 ^ A2, 8), w2 = w2 + x2 | 0, U2 = V$3(U2 ^ w2, 7), T2 = T2 + _3 | 0, C2 = V$3(C2 ^ T2, 16), b2 = b2 + C2 | 0, _3 = V$3(_3 ^ b2, 12), T2 = T2 + _3 | 0, C2 = V$3(C2 ^ T2, 8), b2 = b2 + C2 | 0, _3 = V$3(_3 ^ b2, 7), S3 = S3 + j2 | 0, P3 = V$3(P3 ^ S3, 16), I3 = I3 + P3 | 0, j2 = V$3(j2 ^ I3, 12), S3 = S3 + j2 | 0, P3 = V$3(P3 ^ S3, 8), I3 = I3 + P3 | 0, j2 = V$3(j2 ^ I3, 7), B3 = B3 + U2 | 0, P3 = V$3(P3 ^ B3, 16), b2 = b2 + P3 | 0, U2 = V$3(U2 ^ b2, 12), B3 = B3 + U2 | 0, P3 = V$3(P3 ^ B3, 8), b2 = b2 + P3 | 0, U2 = V$3(U2 ^ b2, 7), A2 = A2 + _3 | 0, R3 = V$3(R3 ^ A2, 16), I3 = I3 + R3 | 0, _3 = V$3(_3 ^ I3, 12), A2 = A2 + _3 | 0, R3 = V$3(R3 ^ A2, 8), I3 = I3 + R3 | 0, _3 = V$3(_3 ^ I3, 7), T2 = T2 + j2 | 0, x2 = V$3(x2 ^ T2, 16), g2 = g2 + x2 | 0, j2 = V$3(j2 ^ g2, 12), T2 = T2 + j2 | 0, x2 = V$3(x2 ^ T2, 8), g2 = g2 + x2 | 0, j2 = V$3(j2 ^ g2, 7), S3 = S3 + L2 | 0, C2 = V$3(C2 ^ S3, 16), w2 = w2 + C2 | 0, L2 = V$3(L2 ^ w2, 12), S3 = S3 + L2 | 0, C2 = V$3(C2 ^ S3, 8), w2 = w2 + C2 | 0, L2 = V$3(L2 ^ w2, 7);
  let k2 = 0;
...
const q$1 = BigInt(0), H$2 = BigInt(1), At$1 = BigInt(2), nc = BigInt(3), en$1 = BigInt(4), Mr$1 = BigInt(5), Dr$1 = BigInt(8);
function X$1(t2, e2) {
  const n3 = t2 % e2;
...
BigInt(8);
function bc(t2) {
  const e2 = BigInt(10), n3 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), i2 = un$1, c2 = t2 * t2 % i2 * t2 % i2, a2 = it$1(c2, Xr$1, i2) * c2 % i2, u2 = it$1(a2, yc, i2) * t2 % i2, l2 = it$1(u2, wc, i2) * u2 % i2, f3 = it$1(l2, e2, i2) * l2 % i2, h4 = it$1(f3, n3, i2) * f3 % i2, y4 = it$1(h4, r2, i2) * h4 % i2, E2 = it$1(y4, o2, i2) * y4 % i2, p2 = it$1(E2, o2, i2) * y4 % i2, d3 = it$1(p2, e2, i2) * l2 % i2;
...
function wa(t2) {
  return !(!t2 || typeof t2 != "object" || !t2.code || !Ae$1(t2.code) || !t2.message || !nt$1(t2.message, false));
}
function ba(t2) {
  return !(Et$2(t2) || !nt$1(t2.method, false));
}
function Ea(t2) {
  return !(Et$2(t2) || Et$2(t2.result) && Et$2(t2.error) || !Ae$1(t2.id) || !nt$1(t2.jsonrpc, false));
}
function va(t2) {
...
function Ia(t2, e2) {
  return Ae$1(t2) && t2 <= e2.max && t2 >= e2.min;
}
function Na() {
  const t2 = xt$2();
...
var Zr = Object.freeze({ __proto__: null, base256emoji: Xr }), Qr = ai, oi = 128, en = 127, tn = ~en, sn = Math.pow(2, 31);
...
class vi {
  constructor(e2, t2, i2) {
    ...
    }), this.core = e2, this.logger = E$5(t2, this.name), this.keychain = i2 || new Di(this.core, this.logger);
  }
  get context() {
    return y$7(this.logger);
  }
...
class Si extends d$3 {
  constructor(e2) {
    ...
    }), this.core = e2.core, this.logger = typeof e2.logger < "u" && typeof e2.logger != "string" ? E$5(e2.logger, this.name) : Ot$2(k$5({ level: e2.logger || Nt })), this.messages = new _i(this.logger, e2.core), this.subscriber = new Ti(this, this.logger), this.publisher = new qn(this, this.logger), this.relayUrl = (e2 == null ? void 0 : e2.relayUrl) || Ue$2, this.projectId = e2.projectId, ei$1() ? this.packageName = ri$1() : ni$1() && (this.bundleId = ri$1()), this.provider = {};
  }
  async init() {
  ...
  try {
    switch (s2) {
      case lo: {
        ...
        for (const [c2, h4] of r2.entries()) if (!e2.has(c2) || !pe$1(h4, e2.get(c2), c2, r2, e2, t2, i2)) return false;
        return true;
      }
      case uo: {
        if (r2.size !== e2.size) return false;
        ...
        for (let l2 = 0; l2 < c2.length; l2++) {
          const d3 = c2[l2], g2 = h4.findIndex((_3) => pe$1(d3, _3, void 0, r2, e2, t2, i2));
      ...
      case Je$1: {
        ...
        for (let d3 = 0; d3 < h4.length; d3++) {
          ...
          const u2 = e2[g2];
          if (!pe$1(_3, u2, g2, r2, e2, t2, i2)) return false;
        }
        return true;
      }
      default:
...
class Li {
  constructor(e2, t2) {
    this.core = e2, this.logger = t2, p$2(this, "name", Mt$1), p$2(this, "version", Kt$1), p$2(this, "events", new Nt$2()), p$2(this, "pairings"), p$2(this, "initialized", false), p$2(this, "storagePrefix", B$2), p$2(this, "ignoredPayloadTypes", [Ft$2]), p$2(this, "registeredMethods", []), p$2(this, "init", async () => {
      ...
      this.isInitialized();
      const s2 = jc(), n3 = await this.core.crypto.setSymKey(s2), o2 = Ei$1(cjs.FIVE_MINUTES), a2 = { protocol: xt$1 }, c2 = { topic: n3, expiry: o2, relay: a2, active: false, methods: i2 == null ? void 0 : i2.methods }, h4 = Wc({ protocol: this.core.protocol, version: this.core.version, topic: n3, symKey: s2, relay: a2, expiryTimestamp: o2, methods: i2 == null ? void 0 : i2.methods });
      return this.events.emit(re$1.create, c2), this.core.expirer.set(n3, o2), await this.pairings.set(n3, c2), await this.core.relayer.subscribe(n3, { transportType: i2 == null ? void 0 : i2.transportType }), { topic: n3, uri: h4 };
      ...
      const d3 = c2 || Ei$1(cjs.FIVE_MINUTES), g2 = { topic: n3, relay: a2, expiry: d3, active: false, methods: h4 };
      ...
      try {
        ...
        throw s2.setError(Y$1.subscribe_pairing_topic_failure), _3;
      }
      ...
      const o2 = formatJsonRpcResult(i2, n3), a2 = await this.core.crypto.encode(s2, o2), c2 = (await this.core.history.get(s2, i2)).request.method, h4 = se$1[c2].res;
      await this.core.relayer.publish(s2, a2, h4), await this.core.history.resolve(o2);
    }), p$2(this, "sendError", async (i2, s2, n3) => {
      const o2 = formatJsonRpcError(i2, n3), a2 = await this.core.crypto.encode(s2, o2), c2 = (await this.core.history.get(s2, i2)).request.method, h4 = se$1[c2] ? se$1[c2].res : se$1.unregistered_method.res;
      await this.core.relayer.publish(s2, a2, h4), await this.core.history.resolve(o2);
    ...
    }), this.core = e2, this.logger = E$5(t2, this.name), this.pairings = new zi(this.core, this.logger, this.name, this.storagePrefix);
  }
  get context() {
    return y$7(this.logger);
  }
...
class Ui extends M$3 {
  constructor(e2, t2, i2) {
    super(e2, t2, i2), this.core = e2, this.logger = t2, this.store = i2, w$1(this, "name", Wt$1), w$1(this, "abortController"), w$1(this, "isDevEnv"), w$1(this, "verifyUrlV3", Yt$1), w$1(this, "storagePrefix", B$2), w$1(this, "version", Le$2), w$1(this, "publicKey"), w$1(this, "fetchPromise"), w$1(this, "init", async () => {
      var s2;
      ...
      try {
        const h4 = getDocument_1(), l2 = this.startAbortTimer(cjs.ONE_SECOND * 5), d3 = await new Promise((g2, _3) => {
          const u2 = () => {
    ...
    }), this.logger = E$5(t2, this.name), this.abortController = new AbortController(), this.isDevEnv = Ii$1(), this.init();
  }
  get storeKey() {
...
class Bi extends R$2 {
  constructor(e2, t2, i2 = true) {
    ...
    }), E$3(this, "getAppDomain", () => Pn$1().url), this.logger = E$5(t2, this.context), this.telemetryEnabled = i2, i2 ? this.restore().then(async () => {
...
let Te$1 = class Te extends h$3 {
  constructor(e2) {
    ...
    const s2 = k$5({ level: typeof (e2 == null ? void 0 : e2.logger) == "string" && e2.logger ? e2.logger : Et$1.logger, name: he$1 }), { logger: n3, chunkLoggerController: o2 } = A$3({ opts: s2, maxSizeInBytes: e2 == null ? void 0 : e2.maxLogBlobSizeInBytes, loggerOverride: e2 == null ? void 0 : e2.logger });
    ...
    }), this.logger = E$5(n3, this.name), this.heartbeat = new i$5(), this.crypto = new vi(this, this.logger, e2 == null ? void 0 : e2.keychain), this.history = new ki(this, this.logger), this.expirer = new ji(this, this.logger), this.storage = e2 != null && e2.storage ? e2.storage : new h$4(qi(qi({}, It$1), e2 == null ? void 0 : e2.storageOptions)), this.relayer = new Si({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Li(this, this.logger), this.verify = new Ui(this, this.logger, this.storage), this.echoClient = new Mi(this.projectId || "", this.logger), this.linkModeSupportedApps = [], this.eventClient = new Bi(this, this.logger, e2 == null ? void 0 : e2.telemetryEnabled), this.setGlobalCore(this);
  }
...
class Ns extends V$4 {
  constructor(n3) {
    super(n3), c$3(this, "name", dt$1), c$3(this, "events", new Nt$2()), c$3(this, "initialized", false), c$3(this, "requestQueue", { state: $$2.idle, queue: [] }), c$3(this, "sessionRequestQueue", { state: $$2.idle, queue: [] }), c$3(this, "requestQueueDelay", cjs.ONE_SECOND), c$3(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c$3(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c$3(this, "recentlyDeletedLimit", 200), c$3(this, "relayMessageCache", []), c$3(this, "pendingSessions", /* @__PURE__ */ new Map()), c$3(this, "init", async () => {
      ...
      if (w2) return await this.sendRequest({ clientRpcId: a2, relayRpcId: l2, topic: i2, method: d3, params: { request: b$3(v$1({}, s2), { expiryTimestamp: Ei$1(r2) }), chainId: t2 }, expiry: r2, throwOnFailedPublish: true, appLink: w2 }).catch((_3) => u2(_3)), this.client.events.emit("session_request_sent", { topic: i2, request: s2, chainId: t2, id: a2 }), await p2();
      ...
      for (const f3 of s2) {
        ...
        const { p: _3 } = f3, g2 = pe$2(_3.resources), A2 = [dr$1(_3.iss)], D2 = De$2(_3.iss);
        if (g2) {
      ...
      try {
        ...
        const p2 = o2.expiryTimestamp || Ei$1(N$2.wc_sessionPropose.req.ttl), h4 = v$1({ id: a2, pairingTopic: t2, expiryTimestamp: p2 }, o2);
        ...
        l2 == null ? void 0 : l2.addTrace(G.emit_session_proposal), this.client.events.emit("session_proposal", { id: a2, params: h4, verifyContext: u2 });
      } catch (l2) {
      ...
      try {
        ...
        const p2 = i2.params.requester.publicKey, h4 = await this.client.core.crypto.generateKeyPair(), u2 = this.getAppLinkIfEnabled(i2.params.requester.metadata, a2), d3 = { type: Ft$2, receiverPublicKey: p2, senderPublicKey: h4 };
  ...
  async onRelayMessage(n3) {
    const { topic: e2, message: t2, attestation: s2, transportType: i2 } = n3, { publicKey: r2 } = this.client.auth.authKeys.keys.includes(ce$1) ? this.client.auth.authKeys.get(ce$1) : { responseTopic: void 0, publicKey: void 0 };
    try {
...
let Ee$1 = class Ee extends J$1 {
  constructor(n3) {
    ...
    const e2 = typeof (n3 == null ? void 0 : n3.logger) < "u" && typeof (n3 == null ? void 0 : n3.logger) != "string" ? n3.logger : Ot$2(k$5({ level: (n3 == null ? void 0 : n3.logger) || me$1.logger }));
...
var ze = Object.defineProperty, ke2 = (s2, t2, e2) => t2 in s2 ? ze(s2, t2, { enumerable: true, configurable: true, writable: true, value: e2 }) : s2[t2] = e2, j = (s2, t2, e2) => ke2(s2, typeof t2 != "symbol" ? t2 + "" : t2, e2);
class We {
  constructor(t2) {
  ...
  registerEventListeners() {
    ...
    this.client.on("session_ping", (t2) => {
      ...
      if (a2.name === "accountsChanged") {
        ...
        const r2 = i2.chainId, c2 = i2.event.data, o2 = yo$1(r2), m3 = K2(r2) !== K2(c2) ? `${o2}:${K2(c2)}` : r2;
...
const ConstantsUtil = {
  ...
  SECURE_SITE_ORIGIN: (typeof process !== "undefined" && typeof define_process_env_default !== "undefined" ? define_process_env_default["NEXT_PUBLIC_SECURE_SITE_ORIGIN"] : void 0) || "https://secure.walletconnect.org",
  VIEW_DIRECTION: {
    Next: "next",
    Prev: "prev"
  },
...
B2 == null ? void 0 : B2(S2, k), (t.litHtmlVersions ?? (t.litHtmlVersions = [])).push("3.3.2");
const D = (t2, i2, s2) => {
...
class AppKit extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await __vitePreload(() => import("./basic-Blra7_TT.js"), true ? __vite__mapDeps([6,7,1,2,3,4,5]) : void 0);
      await __vitePreload(() => import("./w3m-modal-CWrqe4Nl.js"), true ? __vite__mapDeps([8,7,1,2,3,4,5]) : void 0);
...
export {
  ...
  SnackController as B,
  ChainController as C,
  ApiController as D,
  EventsController as E,
  initializeTheming as F,
  CoreHelperUtil as G,
  Hash as H,
  ConstantsUtil$3 as I,
  u$1 as J,
  f$1 as K,
  A as L,
  ...
  StorageUtil as U,
  ConstantsUtil$2 as V,
  WalletUtil as W,
  core as X,
  aexists as a,
  aoutput as b,
  createView as c,
  wrapConstructor as d,
  ahash as e,
  abytes as f,
  concatBytes as g,
  randomBytes as h,
  withErrorBoundary as i,
  subscribeKey as j,
  i$3 as k,
  resetStyles as l,
  i as m,
  ...
  w,
  ConstantsUtil as x,
  ConnectorController as y,
  AccountController as z
};
