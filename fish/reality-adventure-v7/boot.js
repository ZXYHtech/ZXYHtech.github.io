function render(){nav();fab.style.display='block';if(S.screen==='photo'||S.screen==='photoConfirm'||S.screen==='photoCaption'||S.screen==='photoCard')return renderPhoto();if(S.tab==='home')home();else if(S.tab==='play')play();else if(S.tab==='decision')decision();else if(S.tab==='learn')learn();else me()}
