...
function games(){
  ...
  shell(`<div class="hero"><span class="eyebrow">开源小游戏 · 同源镜像</span><h1>只上经过实玩检查的游戏。</h1><div class="lead">所有游戏都直接在本站打开，不跳转第三方页面。MonadFish V8 加入站立遛鱼动作、体感人物联动、全新鱼群和传奇巨物。</div></div>
...
function externalGame(id){
  ...
  const release=id==='monadfish'?'MFV8-1249':'PLAYFIX4';
  ...
  const checkRuntime=(attempt=0)=>{
    try{
      ...
      if(ok){loading.style.display='none';hint.textContent='✅ V8 运行检查通过。可以开始玩。';hint.className='game-hint loaded pass';return}
