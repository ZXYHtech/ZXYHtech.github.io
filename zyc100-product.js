...
window.zyc100Story = function () {
  ...
  return `<section class="zyc-story" aria-label="ZYC100 产品介绍">
    ...
    <section class="zyc-configs"><div class="zyc-title"><span class="zyc-kicker">CHOOSE YOUR SETUP</span><h2>三种配置，按使用方式选择。</h2><p>两款组合均搭配 ZYE660 衰减模块；区别在于模块下方是否集成电池。</p></div><div class="zyc-config-grid">
      <article><img src="${asset('top')}" alt="单独控制器顶视修图示意，已移除 SMA 接头" width="1280" height="1280" loading="lazy"><span class="zyc-kicker">CONTROLLER</span><h3>单独控制器</h3><p>已有兼容模块，或希望自行搭配。控制器本体不包含射频衰减模块。</p><footer>不含 ZYE660 模块 · 询价</footer></article>
      <article><img src="${asset('thin')}" alt="ZYC100 加 ZYE660 无电池薄款组合实拍修图" width="1280" height="1280" loading="lazy"><span class="zyc-kicker">USB POWERED</span><h3>无电池组合 · 薄款</h3><p>控制器 + ZYE660 模块。使用时保持 USB 供电，适合电脑旁和固定测试台。</p><footer>USB 供电 · 询价</footer></article>
      <article><img src="${asset('battery')}" alt="ZYC100 加 ZYE660 集成电池厚款组合实拍修图" width="1280" height="1280" loading="lazy"><span class="zyc-kicker">BATTERY EDITION</span><h3>带电池组合 · 厚款</h3><p>电池集成在模块下方，因此机身更厚。可脱离 USB 供电进行本机操作。</p><footer>模块下方集成电池 · 询价</footer></article>
    </div><p class="zyc-note">组合图基于实拍修图；单独控制器图为从组合照片分离重建的示意图，接口细节以实物为准。价格、库存及交期请咨询确认。</p></section>
