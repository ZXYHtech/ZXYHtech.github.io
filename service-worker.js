const CACHE = 'zya-smart-manual-v1.28.0';
...
const SHELL = [
  ...
  'hybrid.css?v=1.28.0', 'web-serial.css?v=1.24.0', 'runtime-config.js?v=1.28.0',
  'web-serial.js?v=1.28.0', 'app.js?v=1.28.0',
  'zya1000-console.html', 'zya1000-console.css?v=1.28.0', 'zya1000-console.js?v=1.28.0',
