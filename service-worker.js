const CACHE = 'zya-smart-manual-v1.29.8';
const BASE = new URL('./', self.registration.scope);
const SHELL = [
  '', 'styles.css?v=1.24.0', 'admin.css?v=1.24.0', 'admin-operations.css?v=1.29.8',
  ...
  'web-serial.js?v=1.29.0', 'app.js?v=1.29.8',
  'zya1000-console.html?v=1.29.8', 'zya1000-console.css?v=1.29.1', 'zya1000-console.js?v=1.29.8',
