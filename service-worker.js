const CACHE = 'zya-smart-manual-v1.30.9';
const BASE = new URL('./', self.registration.scope);
const SHELL = [
  '', 'styles.css?v=1.24.0', 'admin.css?v=1.24.0', 'admin-operations.css?v=1.30.9',
  ...
  'attenuator.css?v=1.24.0', 'viewer.css?v=1.30.9', 'zye660.css?v=1.24.0',
  'hybrid.css?v=1.29.1', 'web-serial.css?v=1.24.0', 'runtime-config.js?v=1.29.0',
  'web-serial.js?v=1.29.0', 'app.js?v=1.30.9',
