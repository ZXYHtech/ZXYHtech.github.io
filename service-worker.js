...
const CACHE = 'zya-smart-manual-v1.29.5';
...
const SHELL = [
  ...
  'web-serial.js?v=1.29.0', 'app.js?v=1.29.5',
  'zya1000-console.html?v=1.29.5', 'zya1000-console.css?v=1.29.1', 'zya1000-console.js?v=1.29.5',
